...
In the project folder, there are 3 folders and 4 files. flask_session handles session data, static includes the styles.css file, and templates include the HTML files of all the webpages. I will start from the templates.
